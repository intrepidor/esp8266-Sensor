...
const char sHTTP_ENDLABEL_BR[] PROGMEM = "></label><br>";
const char sHTTP_ENDLABELQ_BR[] PROGMEM = "\"></label><br>";
const char sHTTP_ENDLABELQ[] PROGMEM = "\"></label>";
const char sHTTP_ENDBRACEQ[] PROGMEM = "\">";
const char sHTTP_CLOSE_AND_VALUE[] PROGMEM = "\" value=\"";
const char sHTTP_END[] PROGMEM = "</body></html>";
// ## Header
const char sHTTP_TOP[] PROGMEM =
...
"<form action=\"config\" method=\"get\" name=\"Configuration\">";
//
// ## Device Name
const char sHTTP_DEVICE_NAME[] PROGMEM = ""
//"<p><b>Device</b></p>"
"<label>Device name: "
...
//
// ## Thingspeak
const char sHTTP_TS_ENABLE[] PROGMEM = ""
"<br>"//<p><b>Thingspeak</b></p>"
"<label>Thingspeak Enabled"
"<input type=\"checkbox\" name=\"ts_enable\" value=\"tsenable\" ";
// print "checked" or blank
// <ENDLABEL>
const char sHTTP_TS_APIKEY[] PROGMEM = ""
"<label>API Key: "
"<input type=\"text\" name=\"apikey\" value=\"";
// print current apikey
// <ENDLABELQ>
const char sHTTP_TS_IPADDR[] PROGMEM = "<label>IP address: <input type=\"text\" name=\"ipaddr\" value=\"";
// print current ipaddress
// <ENDLABELQ>
//
// ## Port Configuration
const char sHTTP_PORT_HEADING[] PROGMEM = "<p><b>Port Configuration</b></p>";
const char sHTTP_PORT_NUMBER[] PROGMEM = "<label>Port#";
const char sHTTP_PORT_NAME[] PROGMEM = "<input type=\"text\" name=\"port";
const char sHTTP_PORTADJ_NUMBER[] PROGMEM = "<label>Adj#";
const char sHTTP_PORTADJ_NAME[] PROGMEM = " <input type=\"text\" name=\"portadj";
// -- Radio buttons for each port
const char sHTTP_PORT_RADIO_START[] PROGMEM = "<input type=\"radio\" name=\"radport";
...
//
// ## Submit Buttons
const char sHTTP_BUTTONS[] PROGMEM = ""
"<br>"
